...
| Tue | - Learned key concepts of **Amazon SageMaker**: training jobs, tuning, deployment endpoints, and built-in MLOps features. <br> - Explored Studio interface and environment setup for ML experimentation.                                                          | 11/11/2025 | 11/11/2025      | AWS ML Docs, SageMaker Guides          |
| Wed | - Studied **Generative AI with Amazon Bedrock**: Bedrock architecture, Foundation Models (Claude, Llama, Titan), model selection criteria, and cost considerations. <br> - Practiced prompt engineering patterns such as chain-of-thought and few-shot prompting. | 12/11/2025 | 12/11/2025      | AWS GenAI Docs, Internet               |
