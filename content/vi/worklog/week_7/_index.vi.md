...
| 3   | - Thêm route **api/routes/costexplorer.py** để phân tích và tổng hợp chi phí dịch vụ. <br> - Tối ưu hóa hiệu suất truy vấn song song và caching để giảm thời gian phản hồi API.                                                                                | 21/10/2025   | 21/10/2025      | AWS Docs, Internet, mentor hướng dẫn |
| 4   | - Thêm route **api/routes/s3.py** cho truy vấn dữ liệu lưu trữ. <br> - Nghiên cứu về cơ chế phân quyền truy cập (IAM Policy) và tối ưu hóa chi phí lưu trữ S3 thông qua phân lớp dữ liệu (Storage Class).                                                      | 22/10/2025   | 22/10/2025      | Internet, AWS Docs, mentor hướng dẫn |
...
* Bắt đầu áp dụng **Cloud Optimization** vào dự án thực tế — từ giám sát đến quản lý chi phí AWS.
* Tăng cường kỹ năng lập trình backend, quản lý tài nguyên, và vận hành hệ thống tối ưu.